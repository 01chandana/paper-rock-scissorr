...
export class MainComComponent {
  ...
  l_img_url:string="assets/images/ll_paper.jpeg";
  r_img_url:string="assets/images/rr_paper.jpeg";
  ...
  final_result(a:number){
    ...
    switch(a){
      ...
      this.rock_draw();
          break;
      case 31:alert("sci wins");
      this.sci_win();
          break;
      case 32:alert("sci loss");
      this.sci_loss();
          break;
      case 33:alert("sci draw");
      this.sci_draw();
          break;
    }
  }else{
  ...
  this.l_img_url="assets/images/ll_paper.jpeg";
  this.r_img_url="assets/images/rr_rock (2).jpeg";
  ...
  this.l_img_url="assets/images/ll_paper.jpeg";
  this.r_img_url="assets/images/rr_paper.jpeg";
  ...
  this.l_img_url="assets/images/ll_paper.jpeg";
  this.r_img_url="assets/images/rr_sci.jpeg";
  ...
  this.h_win=this.h_win+2;
  this.m_lost=this.m_lost+1;
  this.l_img_url="assets/images/ll_rock.jpeg";
  this.r_img_url="assets/images/rr_sci.jpeg";
  ...
  this.t_match=this.t_match+1;
  this.h_win=this.h_win+2;
  this.m_lost=this.h_lost+1;
  this.l_img_url="assets/images/ll_sci.jpeg";
  this.r_img_url="assets/images/rr_paper.jpeg";
